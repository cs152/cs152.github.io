...
export let activations: {[key: string]: nn.ActivationFunction} = {
  ...
  "leaky": nn.Activations.LEAKY,
};

export let initializers: {[key: string]: nn.Initializer} = {
  "zeros": nn.Initializers.ZEROS,
  "default": nn.Initializers.DEFAULT,
  "uniform": nn.Initializers.UNIFORM,
  "normal": nn.Initializers.NORMAL,
  "kaiminguniform": nn.Initializers.KAIMINGUNIFORM,
  "kaimingnormal": nn.Initializers.KAIMINGNORMAL,
  "xavieruniform": nn.Initializers.GLOROTUNIFORM,
  "xaviernormal": nn.Initializers.GLOROTNORMAL,
};
...
/** A map between dataset names and functions that generate regression data. */
export let reg1dDatasets: {[key: string]: dataset.DataGenerator} = {
  "reg1d-line": dataset.regress1dLine,
  "reg1d-u": dataset.regress1dU,
  "reg1d-sine": dataset.regress1dSine,
  "reg1d-usine": dataset.regress1dUSine,
};
...
export let problems = {
  ...
  "regression1d": Problem.REGRESSION1D,
};
...
export class State {
  ...
  private static PROPS: Property[] = [
    {name: "initializer", type: Type.OBJECT, keyMap: initializers},
    ...
    {name: "reg1dDataset", type: Type.OBJECT, keyMap: reg1dDatasets},
    {name: "learningRate", type: Type.NUMBER},
    {name: "regularizationRate", type: Type.NUMBER},
    {name: "noise", type: Type.NUMBER},
    {name: "mode", type: Type.NUMBER},
  ...
  initializer = nn.Initializers.DEFAULT;
  ...
  reg1dDataset: dataset.DataGenerator = dataset.regress1dLine;
  seed: string;
