...
export function regress1dLine(numSamples: number, noise: number):
  Example2D[] {
  let radius = 6;
  ...
  for (let i = 0; i < numSamples; i++) {
    let x = randUniform(-radius, radius);
    let y = x + randUniform(-radius, radius) * noise;
    let label = y;
    points.push({x, y, label});
  }
  return points;
...
export function regress1dU(numSamples: number, noise: number):
  Example2D[] {
  let radius = 6;
  ...
  for (let i = 0; i < numSamples; i++) {
    let x = randUniform(-radius, radius);
    let y = (x * x / 3 - 5) + randUniform(-radius, radius) * noise;
    let label = y;
    points.push({x, y, label});
  }
  return points;
...
export function regress1dSine(numSamples: number, noise: number):
  Example2D[] {
  let radius = 6;
  ...
  for (let i = 0; i < numSamples; i++) {
    let x = randUniform(-radius, radius);
    let y = Math.sin(x) * 4 + randUniform(-radius, radius) * noise;
    let label = y;
    points.push({x, y, label});
  }
  return points;
...
export function regress1dUSine(numSamples: number, noise: number):
  Example2D[] {
  let radius = 6;
  ...
  for (let i = 0; i < numSamples; i++) {
    let x = randUniform(-radius, radius);
    let y = x * x / 6 + Math.sin(x * 5) / 2 - 3 + randUniform(-radius, radius) * noise;
    let label = y;
    points.push({x, y, label});
  }
  return points;
...
export function classifyCircleDataOld(numSamples: number, noise: number):
    Example2D[] {
  let points: Example2D[] = [];
  let radius = 5;
